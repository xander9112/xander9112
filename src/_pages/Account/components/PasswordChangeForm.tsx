...
import {doPasswordUpdate} from "../../../_firebase";
...
export class PasswordChangeForm extends React.Component<InterfaceProps,
    InterfaceState> {
    ...
    public componentDidMount() {
        // onceGetReminders.on("value", snap => console.log(snap ? snap.val() : null));
        // onceGetReminders.set({username: "fsafsa"});
    }
